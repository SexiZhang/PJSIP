...
- (void)handleIncommingCall:(NSNotification *)notification {
    ...
    NSString *phoneNum = notification.userInfo[@"remote_address"];
    
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    IncommingCallController *incommingCallVC = [storyBoard instantiateViewControllerWithIdentifier:@"IncommingCallController"];
    incommingCallVC.phoneNumber = phoneNum;
    incommingCallVC.callId = call_id;
    
    UIViewController *rootViewController = self.window.rootViewController;
    [rootViewController presentViewController:incommingCallVC animated:YES completion:nil];
}
